...
# print("Power (2^3) using pow():", pow(2, 3)) # 1st version
# print("Power (2^3) using **:", 2 ** 3) # 2nd version
# print("Convert '100' to int:", int("100")) #changes from string to num
...
# print("Stripped spaces:", text.strip()) #removes space between words
# print("Left stripped:", text.lstrip())
# print("Right stripped:", text.rstrip())
# print("Index of 'World':", text.find("World")) #in which number starts the word "World" in the sentence
...
# print("Is '12345' all digits?:", "12345".isdigit()) #all the numbers (ne drobnye) are called digits
...
# name = "Alice"
# age = 25
# print(f"My name is {name} and I am {age} years old.") #output formatting
